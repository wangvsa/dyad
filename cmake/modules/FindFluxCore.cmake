...
if(DEFINED FLUX_CORE_PREFIX)
    set(ENV{PKG_CONFIG_PATH} "${FLUX_CORE_PREFIX}/lib/pkgconfig:${FLUX_CORE_PREFIX}/lib64/pkgconfig:$ENV{PKG_CONFIG_PATH}")
else()
    ...
    if(FLUX)
        ...
        set(ENV{PKG_CONFIG_PATH} "$ENV{PKG_CONFIG_PATH}:${EXTRA_FLUX_CORE_PREFIX}/lib/pkgconfig:${EXTRA_FLUX_CORE_PREFIX}/lib64/pkgconfig")
...
if(${FLUX} STREQUAL "FLUX-NOTFOUND")
    ...
    if (NOT IS_DIRECTORY "${FluxCore_INCLUDE_DIRS}")
        ...
        find_path(FluxCore_LIBRARY_PATH libflux-core.so PATH_SUFFIXES lib/ lib64/)
